...
function showHint(str) {
    if (str.length == 0) { 
        ...
        xmlhttp.open("GET", "fetch.php?q=" + str,false);
        xmlhttp.send();
    }
}
</script>
...
<h4 id="for" >Enter The First name:</h4>
 
<form method="post" action="<?php echo htmlspecialchars("phonesearch.php");?>" id="searchform">
